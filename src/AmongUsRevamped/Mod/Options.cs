...
namespace AmongUsRevamped.Mod
{
    public static class Options
    {
        ...
        public static CustomNumberOption TinySpawnRate;
        ...
        public static void Load()
        {
            ...
            GiantSpawnRate = new CustomNumberOption("giantSpawnRate", $"{Color.ModifierGiant.ToColorTag("Giant")} spawn rate", true, 0f, 0f, 100f, 10f, true, CustomNumberOption.PercentStringFormat);
            TinySpawnRate = new CustomNumberOption("tinySpawnRate", $"{Color.ModifierTiny.ToColorTag("Tiny")} spawn rate", true, 0f, 0f, 100f, 10f, true, CustomNumberOption.PercentStringFormat);
        ...
        public static class Values
        {
            ...
            public static float TinySpawnRate => Options.TinySpawnRate.GetValue();
